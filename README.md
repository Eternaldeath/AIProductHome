...
- AI时代我们需要新的“摩尔定律”
- 如何看待傅盛与朱啸虎激辩：围绕ChatGPT的创业公司有没有价值？

# Readme
- ai model：一个 AI 工具导航网站
- 即时：由文本描述生成可编辑的原型设计稿
- 火山引擎 - 机器学习平台：字节跳动开发的云原生机器学习平台
- 美图设计室：提供大量基于设计领域的 AI 功能，如，AI 试衣，AI 海报 ...
- consensus:   学术方向的 AI 搜索引擎，根据检索内容，提供相关的论文，并总结
- Perplexity AI: 提供类似 new bing 的 AI 检索功能，对检索结果提供数据来源标注
- codeium: copilot 的平替产品，以插件的方式支持主流的编辑器或 IDE
- DragGAN:  图像处理的开源工具，比如，你可以使用该产品来使得狗的嘴闭上
```
